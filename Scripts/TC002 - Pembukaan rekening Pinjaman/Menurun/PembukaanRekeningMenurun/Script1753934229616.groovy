...
//WebUI.click(findTestObject('Object Repository/PembukaanRekeningPinjaman/Page_ARB Banking System/span_MENURUN1'))
...
TestObject optionMenurun1 = new TestObject("optionMenurun1")
optionMenurun1.addProperty("xpath", ConditionType.EQUALS, "//div[contains(@class,'xui-list-item')]//span[normalize-space(text())='MENURUN1']")

WebUI.waitForElementClickable(optionMenurun1, 10)
WebUI.click(optionMenurun1)
WebUI.delay(1)
