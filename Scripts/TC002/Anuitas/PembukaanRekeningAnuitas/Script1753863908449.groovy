...
TestObject inputField = new TestObject('numericInput')
inputField.addProperty('xpath', ConditionType.EQUALS, "//*[@id='xui.UI.ComboInput-INPUT:af:']")

WebUI.waitForElementVisible(inputField, 10)
WebUI.waitForElementClickable(inputField, 10)

WebUI.setText(inputField, "200000")
