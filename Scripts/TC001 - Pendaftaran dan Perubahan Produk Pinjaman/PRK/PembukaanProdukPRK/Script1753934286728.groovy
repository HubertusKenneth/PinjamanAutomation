...
WebUI.click(findTestObject('Object Repository/PembukaanProdukPinjaman/Page_ARB Banking System/span_P - PRK'))
...
//WebUI.click(findTestObject('Object Repository/PembukaanProdukPinjaman/Page_ARB Banking System/span_P - PRK_1'))

WebUI.setText(findTestObject('Object Repository/PembukaanProdukPinjaman/Page_ARB Banking System/input_Biaya Bulanan PRK_xui.UI.ComboInput-INPUTx'),
    '10')

WebUI.sendKeys(findTestObject('Object Repository/PembukaanProdukPinjaman/Page_ARB Banking System/input_Biaya Bulanan PRK_xui.UI.ComboInput-INPUTx'),
    Keys.chord(Keys.ENTER))
